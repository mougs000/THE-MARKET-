...
export default function TheMarket() {
  ...
  useEffect(() => {
    (async () => {
      const [p, o, m, r, s, sup] = await Promise.all([
  ...
  useEffect(() => {
    if (!session) { setProfile(null); setCart([]); return; }
...
/* ---------------- ACCOUNT ---------------- */
function AccountView({ profile, nameInput, setNameInput, onSave, messages, products, respondOffer, onShowAdmin, email, onLogOut, support, onSendSupport, myListings, onMarkSold, onDeleteListing, onRelist, onShowSafety }) {
