...
/* ---------------- ACCOUNT ---------------- */
function AccountView({ profile, nameInput, setNameInput, onSave, messages, products, respondOffer, onShowAdmin, email, onLogOut, support, onSendSupport, myListings, onMarkSold, onDeleteListing, onRelist }) {
